...
const supportedSdgs = [
  {
    ...
    image: "/sdg/goal-04.png",
  },
  {
    id: 6,
    name: "Clean Water & Sanitation",
    image: "/sdg/goal-06.png",
  },
  {
    id: 7,
    name: "Affordable & Clean Energy",
    image: "/sdg/goal-07.png",
  },
  {
    id: 8,
    name: "Decent Work & Economic Growth",
    image: "/sdg/goal-08.png",
  },
  {
    id: 13,
    name: "Climate Action",
    image: "/sdg/goal-13.png",
  },
  {
    id: 15,
    name: "Life on Land",
    image: "/sdg/goal-15.png",
  },
];
function SectionHeading({
  ...
  return (
    <FadeUp>
      <div className="mx-auto max-w-3xl text-center font-display">
        ...
        {subtitle && (
          <p className="mx-auto mt-4 max-w-2xl font-display text-sm leading-relaxed text-[#475569] md:text-base">
            {subtitle}
          </p>
        )}
      </div>
...
export default function ProjectsPage() {
  return (
    <div className="bg-white font-display text-[#0F172A]">

      {/* =========================================================
          HERO SECTION
      ========================================================= */}

      <section className="relative isolate flex min-h-[80vh] items-center justify-center overflow-hidden bg-black px-6 py-20 font-display text-white sm:min-h-[88vh] sm:py-24 lg:min-h-[92vh] lg:py-32">
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-center text-center">
          <FadeUp>
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mx-auto mt-5 max-w-2xl font-display text-base leading-relaxed text-white/90 md:text-lg">
                Creating measurable impact through education,
                sustainability, environmental initiatives and
                community development.
              </p>

              <p className="mx-auto mt-4 max-w-2xl font-display text-sm leading-relaxed text-white/80 md:text-base">
                Empowering schools, students, NGOs, volunteers and
                CSR partners through real-world Sustainable Development
                Goal initiatives.
              </p>
              ...
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                ...
                <a
                  href="#projects"
                  className="btn-arrow inline-flex items-center justify-center gap-2 rounded-full bg-cta px-7 py-3 font-display text-sm font-semibold text-white shadow-[0_0_24px_rgba(255,122,0,0.45)] transition hover:brightness-110"
                >
                  Explore Projects
                ...
                <Link
                  href="/work-with-us"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[#CBD5E1] bg-white/90 px-7 py-3 font-display text-sm font-semibold text-[#0F172A] shadow-[0_14px_35px_-26px_rgba(15,23,42,0.36)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-[#93C5FD] hover:bg-white"
                >
                  Become a Partner
      ...
      <section
        id="projects"
        className="scroll-mt-20 bg-[#F8FAFC] px-6 py-20 font-display sm:py-24"
      >
      ...
      <section className="bg-white px-6 py-20 font-display sm:py-24">
        <div className="mx-auto grid max-w-7xl items-start gap-10 lg:grid-cols-[minmax(0,0.45fr)_minmax(0,0.55fr)] lg:gap-14">
          ...
          <FadeUp>
            <div className="max-w-2xl lg:pr-4">
              ...
              <span className="mt-5 block font-display text-xs font-semibold uppercase tracking-[0.25em] text-[#64748B]">
                Our Focus SDGs
              </span>

              <p className="mt-5 max-w-2xl font-display text-lg font-medium leading-8 text-[#475569]">
                Our projects focus on key Sustainable Development Goals
                that create measurable impact through education, water
                conservation, clean energy, climate action, economic
                growth, and biodiversity.
              </p>

              <Link
                href="/sdg"
                className="btn-arrow mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-cta px-6 py-3 font-display text-sm font-semibold text-white shadow-[0_12px_30px_-16px_rgba(255,122,0,0.9)] transition duration-300 hover:brightness-110"
              >
                Explore Goals
          ...
          {/* SDG Cards */}
          <div className="grid w-full max-w-[560px] grid-cols-2 justify-self-start gap-5 sm:gap-6 md:grid-cols-3 lg:justify-self-end">
      ...
      <section className="bg-[#F8FAFC] px-6 py-20 font-display sm:py-24">
        <FadeUp>
          <div className="mx-auto max-w-7xl rounded-[1.5rem] border border-[#E2E8F0] bg-white px-6 py-12 text-center shadow-[0_24px_80px_-48px_rgba(15,23,42,0.32)] sm:px-10 sm:py-14">
            ...
            <div className="mx-auto max-w-3xl">
              ...
              {/* Badge */}
              <span className="inline-flex items-center gap-2 rounded-full border border-[#E2E8F0] bg-[#F8FAFC] px-4 py-2 font-display text-xs font-semibold uppercase tracking-[0.22em] text-[#64748B] backdrop-blur-xl">
              ...
              <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-cta px-6 py-3 font-display text-sm font-semibold text-white shadow-[0_12px_30px_-16px_rgba(255,122,0,0.9)] transition hover:-translate-y-0.5 hover:brightness-110"
                >
                  Become a Volunteer
                </Link>
                ...
                <Link
                  href="/work-with-us"
                  className="inline-flex items-center justify-center rounded-full border border-[#CBD5E1] bg-white px-6 py-3 font-display text-sm font-semibold text-[#0F172A] shadow-[0_12px_30px_-22px_rgba(15,23,42,0.32)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-[#93C5FD] hover:bg-[#F8FAFC]"
                >
                  Partner with STEPUP
                </Link>
