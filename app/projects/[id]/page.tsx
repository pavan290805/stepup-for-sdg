    ...
    <div className="bg-white text-slate-950">
      <div className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        ...
        <div className="mt-8 flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          ...
          <Link
            href="#"
            className="inline-flex items-center justify-center rounded-full bg-[#c2410c] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#9a3412]"
          >
            Apply now
          </Link>
        </div>
