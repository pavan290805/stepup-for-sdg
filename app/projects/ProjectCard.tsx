...
export function ProjectCard({
  ...
  return (
    ...
    >
        ...
        {isVideo ? (
          ...
          >
            <source
              ...
              type={getVideoType(project.backgroundImage)}
            />
          </video>
        ) : (
          <Image
      ...
      >
        {/* Project Title */}
        <h3 className="font-display text-3xl font-extrabold leading-tight tracking-tight text-[#0F172A] md:text-4xl">
          {project.name}
        </h3>

        {/* Project Description */}
        <p
          className="mt-4 max-w-2xl font-display text-base font-medium leading-relaxed text-[#475569] md:text-lg"
          style={{
            display: "-webkit-box",
  ...
  {/* CTA */}
        <div className="mt-8">
          <Link
            href="/work-with-us"
            className="font-display inline-flex items-center justify-center rounded-full bg-cta px-6 py-3 text-sm font-semibold text-white shadow-[0_12px_30px_-16px_rgba(255,122,0,0.9)] transition duration-300 hover:scale-[1.02] hover:brightness-110 hover:shadow-[0_0_30px_rgba(232,106,0,0.42)]"
          >
            Start This Project
          </Link>
        </div>
