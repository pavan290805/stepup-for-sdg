...
const GLOBAL_STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .mq-track:hover,
  .mq-track-slow:hover { animation-play-state:paused; }
  ...
  .segmented-tab.active { color: #fff; }
...
/* ─── THEMES ──────────────────────────────────────────────────────────────── */
const DARK = {
  pageBg: "#060a10", sectionAlt: "#070c14", card: "#0d1625",
  cardHover: "#101c2e", footer: "#040810",
  border: "#1a2537", borderSubtle: "#111b28", text: "#f0f4f8",
  textSub: "#c8d4e0", muted: "#6b8099", dim: "#3d5166",
...
const LIGHT = {
  pageBg: "#fafbfd", sectionAlt: "#f3f6fa", card: "#ffffff",
  cardHover: "#fafcff", footer: "#111827",
  border: "#e1e8f0", borderSubtle: "#edf2f7", text: "#0d1829",
  textSub: "#374151", muted: "#6b7280", dim: "#9ca3af",
...
interface Partner {
  ...
  /** multi-source logo URLs tried in order until one loads */
  logoSources: string[];
  domain?: string;
}
...
const typeConfig: Record<PartnerType, {
  ...
  badgeText: string; gradient: string;
...
const partners: Partner[] = [
  {
    id: 1, name: "Delhi Public School", type: "School", city: "New Delhi", initials: "DPS",
    sdgs: [4, 13], since: "2023",
    ...
    domain: "dpsrkp.net",
    logoSources: [
      "https://dpsrkp.net/wp-content/uploads/2019/06/logo-png-152x195.png",
      "https://upload.wikimedia.org/wikipedia/en/3/3c/Delhi_Public_School_logo.png",
      "https://www.dpssociety.in/images/dps-logo.png",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://dpsrkp.net&size=128`,
    ],
  },
  {
    id: 2, name: "GreenEarth Initiative", type: "NGO", city: "Hyderabad", initials: "GE",
    sdgs: [13, 15], since: "2024",
    ...
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Green_Earth_logo.svg/240px-Green_Earth_logo.svg.png",
      "https://cdn.brandfetch.io/greenearth.org/w/128/h/128",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://greenearth.org&size=128`,
    ],
  },
  {
    id: 3, name: "TechCorp India", type: "Company", city: "Bangalore", initials: "TC",
    sdgs: [4, 9], since: "2023",
    ...
    funds: "Rs50L", fundsLakh: 50, tier: "Gold",
    domain: "techcorp.in",
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Tata_Consultancy_Services_Logo.svg/240px-Tata_Consultancy_Services_Logo.svg.png",
      "https://cdn.brandfetch.io/tcs.com/w/128/h/128",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://tcs.com&size=128`,
    ],
  },
  {
    id: 4, name: "IIT Hyderabad", type: "University", city: "Hyderabad", initials: "IIT",
    sdgs: [4, 9, 17], since: "2023",
    ...
    logoSources: [
      ...
      "https://www.iith.ac.in/assets/images/iith-logo.png",
      "https://iith.ac.in/images/logo.png",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://iith.ac.in&size=128`,
    ],
  },
  {
    id: 5, name: "Bright Futures Academy", type: "School", city: "Mumbai", initials: "BF",
    sdgs: [4, 10], since: "2024",
    ...
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Kendriya_Vidyalaya_logo.svg/240px-Kendriya_Vidyalaya_logo.svg.png",
  ...
  {
    id: 6, name: "EcoVolt Energy", type: "Company", city: "Chennai", initials: "EV",
    sdgs: [7, 13], since: "2024",
    story: "Brought hands-on renewable-energy labs to schools.",
    lastActivity: "New funding round confirmed · 6 days ago",
    funds: "Rs20L", fundsLakh: 20, tier: "Silver",
    domain: "ecovolt.in",
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Tata_Power_Logo.svg/240px-Tata_Power_Logo.svg.png",
      "https://cdn.brandfetch.io/ecovolt.in/w/128/h/128",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://ecovolt.in&size=128`,
    ],
  },
  {
    id: 7, name: "Hope NGO", type: "NGO", city: "Delhi", initials: "HN",
    sdgs: [1, 10], since: "2024",
    ...
    domain: "hopengo.org",
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/CRY_logo.svg/240px-CRY_logo.svg.png",
      "https://cdn.brandfetch.io/hopengo.org/w/128/h/128",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://hopengo.org&size=128`,
    ],
  },
  {
    id: 8, name: "Woxsen University", type: "University", city: "Hyderabad", initials: "WU",
    sdgs: [4, 17], since: "2025",
    ...
    logoSources: [
      ...
      "https://woxsen.edu.in/wp-content/uploads/2021/05/woxsen-logo.png",
      "https://woxsen.edu.in/images/logo.png",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://woxsen.edu.in&size=128`,
    ],
  },
  {
    id: 9, name: "InfraBuild Corp", type: "Company", city: "Mumbai", initials: "IB",
    sdgs: [9, 11], since: "2024",
    ...
    funds: "Rs30L", fundsLakh: 30, tier: "Silver",
    domain: "l-and-t.com",
    logoSources: [
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Larsen_%26_Toubro_logo.svg/240px-Larsen_%26_Toubro_logo.svg.png",
      "https://cdn.brandfetch.io/larsentoubro.com/w/128/h/128",
      `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://larsentoubro.com&size=128`,
    ],
  },
];

/* ─── MARQUEE LOGOS — fixed with brandfetch + google favicon fallback ─────── */
...
function formatFunding(lakh: number) {
  if (lakh >= 100) { const cr = lakh / 100; return `Rs${cr % 1 === 0 ? cr.toFixed(0) : cr.toFixed(1)}Cr+`; }
  return `Rs${lakh}L+`;
}
const totalFundsLakh = partners.reduce((s, p) => s + (p.fundsLakh ?? 0), 0);
const fundingStat = formatFunding(totalFundsLakh);

const heroFloatingCards = [
  { label: "CSR Funding",       value: "Rs1Cr+", sub: "Enabled this year",  delay: 0,    floatDur: 3.2, floatAmt: 8  },
...
const Icon = {
  ...
  Globe: ({ className = "w-3.5 h-3.5", style }: { className?: string; style?: React.CSSProperties }) => (
  ...
  TrendUp: ({ className = "w-3 h-3" }: { className?: string }) => (
  ...
  BarChart: ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
  ...
  Megaphone: ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/* ─── MULTI-SOURCE LOGO IMAGE ─────────────────────────────────────────────── */
function MultiSourceImg({
  sources, alt, initials, color, gradient, border,
  className, style, isDark,
}: {
  sources: string[]; alt: string; initials: string;
  ...
  if (allFailed || sources.length === 0) {
    ...
    return (
      <div className={className} style={{
        ...
        <span style={{ color, fontWeight: 900, fontSize: "clamp(14px, 2.5vw, 26px)", letterSpacing: "-0.03em" }}>
          {initials}
        </span>
      </div>
    );
  ...
  return (
    <div className={className} style={{ ...style, position: "relative", overflow: "hidden" }}>
      {!loaded && (
        <div className="logo-shimmer" style={{ position: "absolute", inset: 0, borderRadius: "inherit" }} />
      )}
      <img
        key={idx}
        src={sources[idx]}
      ...
      <motion.div
        ...
        style={{
          background: useTransform([glowX, glowY], ([gx, gy]) =>
            `radial-gradient(circle at ${gx}% ${gy}%, rgba(14,165,201,0.08) 0%, transparent 60%)`)
        }}
      />
      {children}
    </motion.div>
...
/* ─── PARTNER CARD HEADER with real logo ─────────────────────────────────── */
...
function PartnerCard({ partner, onSelect, theme, isDark }: { partner: Partner; onSelect: () => void; theme: T; isDark: boolean }) {
  ...
  return (
    <TiltCard onClick={onSelect} className="group relative cursor-pointer shine-sweep"
      style={{
        background: theme.card, border: `1px solid ${hovered ? cfg.border : theme.border}`,
        ...
        <div className="p-5 flex flex-col gap-3">
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <div className="flex items-center gap-1 mt-1 text-[11px]" style={{ color: theme.muted }}>
          ...
          <div className="flex items-center gap-2">
            ...
            {partner.funds && (
              <span className="ml-auto text-[10px] font-semibold" style={{ color: cfg.color }}>{partner.funds}</span>
            )}
          </div>
          <div className="flex flex-wrap gap-1.5">
            {partner.sdgs.map(n => <SDGChip key={n} num={n} theme={theme} />)}
          </div>
          <div className="flex items-center gap-2 pt-3 text-[10px]"
            style={{ borderTop: `1px solid ${theme.border}`, color: theme.dim }}>
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {metrics.map(([val, label]) => (
              <motion.div key={label} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.05 }} className="rounded-2xl p-4 text-center"
            ...
            <div>
              ...
              {COMPANY_PROJECTS.map((p, i) => (
                <div key={p.name} className="relative flex gap-3 pb-4 pl-1 last:pb-0">
                  ...
                  <span className="z-10 mt-1 h-3.5 w-3.5 shrink-0 rounded-full border-2 transition-colors"
...
/* ─── MARQUEE LOGO CARD — 3-source fallback ───────────────────────────────── */
function MarqueeLogoCard({ logo, theme, isDark }: {
  logo: { name: string; domain: string; wiki: string };
  theme: T; isDark: boolean;
}) {
  // Sources: 1) Wikipedia SVG/PNG  2) Brandfetch CDN  3) Google favicon  4) text fallback
  const sources = [
    logo.wiki,
    `https://cdn.brandfetch.io/${logo.domain}/w/180/h/60/logo`,
    `https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://${logo.domain}&size=128`,
  ];
  ...
  const tryNext = () => {
    if (idx + 1 < sources.length) { setIdx(i => i + 1); setLoaded(false); }
  ...
  return (
    <div className="logo-pill mx-3 flex items-center justify-center rounded-2xl px-5"
      style={{
        minWidth: 160, height: 76, flexShrink: 0, position: "relative", overflow: "hidden",
      ...
      {allFailed ? (
        <span style={{
          ...
          color: isDark ? "rgba(255,255,255,0.45)" : theme.muted,
        ...
        <>
          ...
          <img
            ...
            onError={tryNext}
            style={{
              maxWidth: 120, maxHeight: 40, objectFit: "contain", display: "block",
              opacity: loaded ? 1 : 0,
              transition: "opacity 0.35s ease, filter 0.3s ease",
              filter: isDark ? "brightness(0.85) saturate(0.9)" : "brightness(0.95) saturate(1)",
            }}
          />
        </>
      )}
  ...
  return (
    <div className="overflow-hidden py-2" style={{
      ...
      <div className="mq-track-slow" style={{ alignItems: "center", padding: "8px 0" }}>
        {doubled.map((logo, i) => (
          <MarqueeLogoCard key={`${logo.domain}-${i}`} logo={logo} theme={theme} isDark={isDark} />
        ))}
      </div>
    </div>
  );
...
export default function PartnersPage() {
  ...
  function updateForm<K extends keyof ApplyForm>(key: K, val: ApplyForm[K]) {
      ...
      <motion.nav initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
        ...
        <div className="flex items-center gap-2.5">
          ...
          <select className="rounded-lg px-2.5 py-1.5 text-[11px] font-medium focus:outline-none"
            ...
            defaultValue="EN" aria-label="Select language">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search by name or city..."
                ...
                style={{
                  ...
                  border: `1.5px solid ${searchFocused ? theme.accent : theme.border}`,
                  color: theme.text,
              ...
              {tabs.map(tab => {
                ...
                return (
                  <button key={tab} onClick={() => setActiveTab(tab)}
                    ...
                    {isActive && (
                      <motion.span layoutId="tab-indicator" className="absolute inset-0 rounded-lg z-0"
          ...
          <motion.div layout className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <AnimatePresence mode="popLayout">
              {filtered.map((partner, idx) => (
                <motion.div key={partner.id} layout
                  ...
                  <ul className="flex flex-col gap-3">
                    {card.benefits.map(b => (
                      <li key={b} className="flex items-start gap-2.5 text-[13px] leading-snug" style={{ color: theme.muted }}>
                        <Icon.Check className="mt-0.5 w-3.5 h-3.5 shrink-0" style={{ color: theme.accent }} />
                        {b}
                      </li>
                    ))}
                  </ul>
        ...
        <Reveal delay={0.1}>
          <div className="mb-6 rounded-[20px] p-7" style={{ background: theme.card, border: `1px solid ${theme.border}` }}>
            ...
            <div className="grid gap-3.5 md:grid-cols-3">
              {[
                { IconEl: Icon.BarChart,  ...partnershipModels[0] },
                { IconEl: Icon.Handshake, ...partnershipModels[1] },
                { IconEl: Icon.Megaphone, ...partnershipModels[2] },
              ].map(m => (
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={text} className="flex items-center gap-2.5 text-[12px]" style={{ color: theme.muted }}>
                    <Ico className="w-3.5 h-3.5 shrink-0" style={{ color: theme.accent }} />
                    {text}
                  </div>
                ))}
              </div>
