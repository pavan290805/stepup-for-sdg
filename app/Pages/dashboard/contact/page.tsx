...
const MESSAGES = [
  ...
  { id: 4, from: 'Hope Foundation', email: 'team@hopefoundation.org', subject: 'Funding Collaboration Proposal', body: 'We are reaching out to propose a joint funding initiative for SDG 1 and SDG 2. We believe a combined effort could maximize our impact significantly.', time: 'Mon', date: 'Mon', unread: false, tag: 'Partner', avatar: 'H' },
  { id: 5, from: 'City School District', email: 'district@cityschools.gov', subject: 'Annual Partnership Renewal', body: 'Our annual partnership agreement is due for renewal next month. Please advise on the process and any updates to the terms for the upcoming year.', time: 'Sun', date: 'Sun', unread: false, tag: 'School', avatar: 'C' },
  { id: 6, from: 'AquaLife Trust', email: 'hello@aqualife.org', subject: 'New Project Proposal — SDG 6', body: 'We have developed a new proposal for clean water access in rural areas. We would love to present this to your team at the earliest convenience.', time: 'Fri', date: 'Fri', unread: false, tag: 'Partner', avatar: 'A' },
]
...
const TAG_COLORS: Record<string, string> = { Partner: '#3b6ef6', School: '#10b981' }
...
export default function ContactCentrePage() {
  ...
  const markRead = (id: number) => setMessages(ms => ms.map(m => m.id === id ? { ...m, unread: false } : m))
          ...
          <div style={{ background: c.surface, border: `1px solid ${c.border}`, borderRadius: 14, boxShadow: c.shadow, overflow: 'hidden' }}>
            ...
            <div style={{ padding: '14px 14px 10px', borderBottom: `1px solid ${c.border}` }}>
              ...
              <div style={{ display: 'flex', gap: 6 }}>
                {['All', 'Unread', 'Partner', 'School'].map(f => (
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 }}>
                        ...
                        <span style={{ fontSize: 9.5, fontWeight: 700, color: TAG_COLORS[msg.tag], background: TAG_COLORS[msg.tag] + '18', padding: '2px 7px', borderRadius: 20, flexShrink: 0 }}>{msg.tag}</span>
                      </div>
                    </div>
            ...
            {compose ? (
              ...
              <div style={{ padding: 24 }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 18 }}>
                  ...
                  <span style={{ fontSize: 10.5, fontWeight: 700, color: TAG_COLORS[selected.tag], background: TAG_COLORS[selected.tag] + '18', padding: '4px 12px', borderRadius: 20 }}>{selected.tag}</span>
                </div>
