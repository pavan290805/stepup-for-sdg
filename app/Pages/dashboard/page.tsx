...
export default function DashboardPage() {
  ...
  return (
    <main style={{ flex: 1, padding: '24px 28px 40px', display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 14 }}>
        {[
          { label: 'Total Students',    value: '12,450', change: '+12% this month', up: true,  color: '#3b6ef6' },
          { label: 'Schools Supported', value: '142',    change: '+5 new schools',  up: true,  color: '#8b5cf6' },
